...
public class RestartButton extends JButton implements MouseListener {
	...
	public RestartButton(Icon icon) {
		super(icon);
		pressed  = new ImageIcon("UI/button/restart1_p1.png");
		rolled  = new ImageIcon("UI/button/restart1_p.png");
	...
	public void setAnalyse(AnalyseVideo analyse) {
		System.out.println("Analayse set !");
